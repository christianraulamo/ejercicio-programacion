package ejerciciosdel29al34.matematicas;
...
public class Varias {
   ...
   * 
   * @param x  array bidimiensional de números enteros
   * @param fila número de la fila que se quiere extraer del array <code>x</code>
   * @return fila en forma de array unidimensional extraida del array <code>x</code>
   */
   ...
   * y la columna donde se encuentra <code>n</code> o <code> {-1, -1}</code> en 
   ...
   * 
   * @return  verdadero si el número que se encuentra en la fila <code>i </code> 
   * y la columna <code>j</code> es el mínimo en sufila y el máximo en su columna.
   */
   ...
   * @param x array bidimiensional de números enteros
   * 
   * @param fila fila del número que marcará las dos posibles diagonales dentro
   ...
   * diagonales se devolverá; la cadena <code> "nose"</code> indica que se elige
   * la diagonal que va del noroeste hacia el sureste, mientras que la cadena 
   * <code>"neso"</code> indica que se elige la diagonal que va del noreste 
   * hacia el suroeste
   * 
   * @return array unidimensional que contiene una diagonal definida por un número
   * determinado por <code>fila </code> y <code>columna</code> y una dirección 
   * determinada por el parámetro <code>direccion </code>
   */
