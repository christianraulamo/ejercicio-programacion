...
public class Ejercicio30 {
  ...
  public static void main (String args[]) {
    ...
    do {
      ...
      System.out.println("Meta la segunda hora.");
      System.out.print("Día: ");
      ...
      if ((primerDia == 0) || (segundoDia == 0)) {
        System.out.println("No existe ese dia en la semana.");
      ...
      if ((primeraHora < 0) || (primeraHora > 23) || (segundaHora < 0) || (segundaHora > 23)) {
        System.out.println("Esa hora no lo tiene el dia.");
